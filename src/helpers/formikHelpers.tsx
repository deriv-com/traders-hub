 ...
 * array fields (if any)
 * @param formikErrors - The errors object from Formik
 * @returns string[] - An array of error field names
 */
 ...
 * to the user.
 *
 * @param fieldOrder An array of field names in the order they appear in the form.
 *
