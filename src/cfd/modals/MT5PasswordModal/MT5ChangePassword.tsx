...
import { useTradingPlatformPasswordChange } from '@deriv-com/api-hooks';
  ...
  return (
    <Fragment>
      <Modal.Body className='lg:p-24 lg:max-w-[525px]'>
        <Text size='sm'>
          To enhance your MT5 account security we have upgraded our password policy. Please update your password
          accordingly.
        </Text>
        <PasswordInput
          isFullWidth
