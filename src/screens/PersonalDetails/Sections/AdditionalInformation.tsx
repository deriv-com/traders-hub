...
import { useResidenceList } from '@deriv-com/api-hooks';
 ...
 * @description The AdditionalInformation component is used to display the additional information section in the personal details screen.
